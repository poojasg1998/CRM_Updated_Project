...
declare var $: any;
@Component({
  selector: 'app-retail-junk-form',
  templateUrl: './retail-junk-form.component.html',
  styleUrls: ['./retail-junk-form.component.scss'],
})
export class RetailJunkFormComponent implements OnInit {
